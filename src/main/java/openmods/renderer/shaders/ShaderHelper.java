...
public class ShaderHelper {
	...
	public interface IShaderMethods {
		...
		void glUniform2f(int loc, float u, float v);
	...
	private static class GL20ShaderMethods implements IShaderMethods {
		...
		@Override
		public void glUniform2f(int loc, float u, float v) {
			GL20.glUniform2f(loc, u, v);
		}
	...
	private static class ARBShaderMethods implements IShaderMethods {
		...
		@Override
		public void glUniform2f(int loc, float u, float v) {
			ARBShaderObjects.glUniform2fARB(loc, u, v);
		}
