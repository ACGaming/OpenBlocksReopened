...
@Mod(modid = OpenMods.MOD_ID, name = OpenMods.NAME, version = OpenMods.VERSION, guiFactory = OpenMods.GUI_FACTORY)
public class OpenMods {

	public static final String MOD_ID = "openmods";
	public static final String NAME = "OpenModsLib";
	public static final String VERSION = Tags.LIB_VERSION;
	...
	public void preInit(FMLPreInitializationEvent evt) {
		...
		ConfigProcessing.processAnnotations(MOD_ID, config, LibConfig.class);
		MinecraftForge.EVENT_BUS.register(new ConfigChangeListener(MOD_ID, config));
